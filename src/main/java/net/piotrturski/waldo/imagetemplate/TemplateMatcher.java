...
public class TemplateMatcher {
    ...
    static Optional<MatchResult> match(Mat image, Mat template) {
        ...
        System.out.println(String.format("image rows: %s, cols: %s", image.rows(), image.cols()));
        System.out.println(String.format("template rows: %s, cols: %s", template.rows(), template.cols()));
        System.out.println(String.format("result rows: %s, cols: %s", resultRows, resultCols));
        ...
        System.out.println("max: "+maxLoc.x()+", "+maxLoc.y()+" val: "+maxVal.get());

        System.out.println(String.format("top-left (%s,%s)", maxLoc.x(), maxLoc.y()));
